# This file, when included, constructs a multidimensional FSBP operator exact for polynomials of degree up to 1 and the steady state of the problem defined in triangSteadyTest.jl
...
fcts = [cons, linx, liny, p1, p2, p3, p4]
...
dxfcts = [x->0.0,  dxlinx, dxliny, dxp1, dxp2, dxp3, dxp4]
dyfcts = [x->0.0,  dylinx, dyliny, dyp1, dyp2, dyp3, dyp4]


No = 36					# Number of nodes on the boundary (from now termed outer nodes)
Ni = 24					# Additional nodes in the interrior (from now termed inner nodes)
